      ...
      <div class="card">
        <div class="accordion-item p-3">
          ...
          <div id="flush-collapseOne" class="accordion-collapse collapse show mt-3" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample" style="">
            <form class="row g-3" action="{{route('admin.rent.raw')}}">
                        ...
                        @if( !empty( $rent_raws ) )
                            @foreach( $rent_raws as $value )
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.rent.edit', $value->rent_id)}}" class="btn btn-sm btn-warning"><i class="bi bi-pencil-square small"> Sửa</i></a>
