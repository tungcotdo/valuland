...
@section('admin.main')
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                      ...
                      <div class="col-md-4 validate">
                        ...
                        <input type="text" class="form-control form-control-sm" id="owner_email" name="owner_email" value="{{$rent->owner_email}}">
                        <small class="error-message text-danger"></small>
                      </div>
                      <div class="col-md-4 validate">
                      ...
                      <div class="col-md-4">
                        ...
                        <input type="text" class="form-control form-control-sm" id="rent_subdivision" name="rent_subdivision" value="{{$rent->rent_subdivision}}">
                      </div>
                      <div class="col-md-4">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{route('admin.media.rent-upload', $rent->rent_id)}}" id="admin-rent-uploadimg" method="POST" enctype="multipart/form-data">
                <input type="hidden" id="rent-loadimg-url" value="{{route('admin.media.rent-load', $rent->rent_id)}}">
                @csrf
                <div class="row">
    ...
    <script src="{{asset('form/rent.js')}}"></script>
    @endsection
