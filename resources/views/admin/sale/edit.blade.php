    ...
    <div class="modal fade" id="videoModal" tabindex="-1">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{route('admin.media.sale-upload', $sale->sale_id)}}" id="admin-sale-uploadvideo" method="POST" enctype="multipart/form-data">
                <input type="hidden" id="sale-loadvideo-url" value="{{route('admin.media.sale-load', $sale->sale_id)}}">
                @csrf
                <div class="row">
                    <div class="col-auto validate">
