...
@section('admin.main')
    <div class="pagetitle">
      ...
      <div class="card-btns">
        <a href="{{route('admin.sale.add')}}" class="btn btn-sm btn-success"><i class="bi bi-upload"></i> Tải file excel</a>
        <a href="{{route('admin.sale.add')}}" class="btn btn-sm btn-warning disabled"><i class="bi bi-download"></i> Xuất file excel</a>
      </div>
