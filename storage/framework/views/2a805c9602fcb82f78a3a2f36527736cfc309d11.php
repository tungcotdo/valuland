      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row">
            ...
            <!-- Start raw -->
            <form class="col-12" action="<?php echo e(route('admin.authorization.store')); ?>" method="POST">
              <?php echo csrf_field(); ?>
              <div class="card">
                <div class="card-body">
              ...
              <div class="card mt-3">
                <div class="card-body">
                    <h5 class="card-title py-0 mb-3">Các chức năng</h5>
                    <div class="row">
                        ...
                        <tbody>
                            <?php if( !empty( $functions ) ): ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                      <input class="form-check-input" type="checkbox" name="function_select[]" value="<?php echo e($value->function_id); ?>">
                                    </td>
                                </tr>
