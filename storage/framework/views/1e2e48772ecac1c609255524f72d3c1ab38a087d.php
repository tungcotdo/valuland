            ...
            <div class="card-body">
                ...
                <div class="row">
                    <?php $__currentLoopData = $user_groups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-md-2">
                        <input <?php echo e(in_array( $value->user_group_id, $notification_user ) ? 'checked' : ''); ?> class="form-check-input" type="checkbox" name="notification_user[<?php echo e($value->user_group_id); ?>]" id="notification_user_<?php echo e($key); ?>" value="<?php echo e($value->user_group_name); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel8valuland\resources\views/admin/notification/edit.blade.php ENDPATH**/ ?>