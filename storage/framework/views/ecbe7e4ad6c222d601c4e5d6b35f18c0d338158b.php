...
<html lang="en">
  ...
  <body>
    <form action="<?php echo e(route('')); ?>">
      <div class="mb-3">
        <label for="exampleInputEmail1" class="form-label-sm">Email address</label>
...
</html><?php /**PATH C:\tungc\App Installation\xampp742\htdocs\tool\resources\views/payment_transaction/index.blade.php ENDPATH**/ ?>