<html>
    ...
    <body>
        <div>
            <div style="font-size: 15px;padding: 0 20px;margin: 0;">

                <div style="font-size: 15px;font-family: 'Arial', sans-serif; margin: 0;">
                    ...
                    <p style="font-family: 'Arial', sans-serif;font-size: 22px;font-weight: bold;margin-top: 0;margin-bottom: 10px;">You are applying for:</p>
                    
                    <table style="width:100%;" cellpadding="3">
                        <tr>
                            <td style="font-family: 'Arial', sans-serif;font-size: 17px;text-align:left;color:#403f41;padding: 5px 0;">
                                - <?php echo e($student->scholarship); ?>

                                
                                <?php if( $student->scholarship == 'Nationwide Scholarship' ): ?>
                                    <ul style="margin-left: 15px;">
                                        <li>Academic Excellence Scholarship: The British Ambassador’s Scholarship/ Vice Chancellor’s Scholarship/ Dean’s Scholarship</li>
                                        <li>Talent Scholarship</li>
                                        <li>Disciplines Scholarship</li>
                                    </ul>
                                <?php endif; ?>
                            </td>
                        </tr>
                        ...
                        <?php if( !empty( $student->scholarship_other ) ): ?>
                            <tr>
                                <td style="font-family: 'Arial', sans-serif;font-size: 17px;text-align:left;color:#403f41;padding: 5px 0;">
                                    - Others (Please specify: <?php echo e($student->scholarship_other); ?>)
                                </td>
                            </tr>
                        <?php endif; ?>
                    </table>
                    ...
                    <table style="width:100%;  margin: 30px 0;" cellpadding="3">
                        <tr>
                            <td width="30%" style="font-family: 'Arial', sans-serif;font-size: 17px;text-align:left;color:#403f41;padding: 0 15px 0 0;text-align: right">
                                Full name
                            </td>
                            ...
                            <td style="vertical-align: top;padding: 0;" colspan="2">
                                <table style="width:100%;border-collapse: collapse;margin: 0" border="0" cellpadding="0">
                                    ...
                                    <tr style="margin: 6px 0;">
                                        ...
                                        <td style="vertical-align:top;font-size: 15px;font-family: 'Arial', sans-serif;padding: 3px 0;">
                                            Gender: <strong><input type="checkbox" <?php echo e(!empty($student->gender == 1 ) ? 'checked="checked"' : ''); ?>> Male</strong> <strong><input
                                            type="checkbox" <?php echo e(!empty($student->gender == 2 ) ? 'checked="checked"' : ''); ?>> Female</strong>
                                            <strong><input type="checkbox" <?php echo e(!empty($student->gender == 3 ) ? 'checked="checked"' : ''); ?>> Other</strong>
                                        </td>
                                    </tr>
                                    <tr style="margin: 6px 0;">
                                        <td colspan="3"
                    ...
                    <table style="width:100%;font-size:12px; border-collapse: collapse;" border=1
                        ...
                        <tr>
                            <td style="height:28px;font-size: 15px;">
                                <p><?php echo e(!empty($qualification_text[$qualification->qualification_1]) ? $qualification_text[$qualification->qualification_1] : $qualification->qualification_other_1); ?></p>
                            </td>
                        ...
                        <tr>
                            <td style="height:28px;font-size: 15px;">
                                <p><?php echo e(!empty($qualification_text[$qualification->qualification_2]) ? $qualification_text[$qualification->qualification_2] : $qualification->qualification_other_2); ?></p>
                            </td>
                        ...
                        <tr>
                            <td style="height:28px;font-size: 15px;">
                                <p><?php echo e(!empty($qualification_text[$qualification->qualification_3]) ? $qualification_text[$qualification->qualification_3] : $qualification->qualification_other_3); ?></p>
                            </td>
                        ...
                        <tr>
                            <td style="height:28px;font-size: 15px;">
                                <p><?php echo e(!empty($qualification_text[$qualification->qualification_4]) ? $qualification_text[$qualification->qualification_4] : $qualification->qualification_other_4); ?></p>
                            </td>
                        ...
                        <tr>
                            <td style="height:28px;font-size: 15px;">
                                <p><?php echo e(!empty($qualification_text[$qualification->qualification_5]) ? $qualification_text[$qualification->qualification_5] : $qualification->qualification_other_5); ?></p>
                            </td>
                ...
                <div style="display: block;width: 100%;float: left;margin-bottom: 15px;">
                    ...
                    <table style="width:100%;font-size:12px; border-collapse: collapse;" border=1 cellpadding="6">
                        <tr style="background-color: #ddd">
                ...
                <div style="display: block;width: 100%;float:left;margin-bottom: 15px;">
                    ...
                    <div style="width: 100%; margin-bottom: 6px; float: left;">
                        <div style="width: 100%;">
                            ...
                            <label for="scholarship-section__field-checkbox-input-1" class="scholarship-section__field-checkbox-label"> <?php echo e(!empty( $program_selection[0] ) ? $program_selection[0] : ''); ?></label>
                    ...
                    <table style="width:100%;font-size: 13px;font-family: 'Arial', sans-serif;">
                        ...
                        <tr>
                            <td style="width: 20%; vertical-align:top;font-size: 15px;font-family: 'Arial', sans-serif;padding: 3px 0;">
                                <label><input type="checkbox" <?php echo e(isset( $programme->english_is_secondary ) && $programme->english_is_secondary == 1  ? 'checked="checked"' : ''); ?> /> Yes</label>
                            </td>
                            <td style="width: 20%; vertical-align:top;font-size: 15px;font-family: 'Arial', sans-serif;padding: 3px 0;">
                                <label><input type="checkbox" <?php echo e(isset( $programme->english_is_secondary ) && $programme->english_is_secondary == 0  ? 'checked="checked"' : ''); ?> /> No</label>
                            </td>
                        ...
                        <?php if( !empty( $programme->english_test_taken ) && $programme->english_test_taken != 'No' ): ?>
                            <tr>
                                <td colspan="3"
                                    style="vertical-align:top;font-size: 15px;font-family: 'Arial', sans-serif;padding: 3px 0;">
                            ...
                            <tr>
                                <td style="width: 20%; vertical-align:top;font-size: 15px;font-family: 'Arial', sans-serif;padding: 3px 0;">
                                    <label> <?php echo e($programme->english_test_taken == 'Others' ? $programme->english_test_other : $programme->english_test_taken); ?></label>
                                </td>
                            </tr>
                ...
                <div style="display: block;width: 100%;float: left;margin-bottom: 15px;">
                    <div style="background-color: #d92027; padding: 3px 6px 2px;font-size: 16px;font-weight: bold; font-family: 'Arial', sans-serif; text-transform: uppercase; color: #fff;">
                    ...
                    <p>3. How will the major you have applied for contribute significantly to the development of Vietnam?</p>
                    ...
                    <p>5. How will you contribute to British University Vietnam if you study here? </p>
                ...
                <div style="display: block;width: 40%;float: left;margin-bottom: 15px;">
                    ...
                    <?php if( file_exists('upload/'.$document->sid.'/'.$document->signature) ): ?>
                        <p style="margin-bottom: 0;"><img src="<?php echo e(asset('upload/'.$document->sid.'/'.$document->signature)); ?>" width="190"></p>
                    <?php endif; ?>
...
</html><?php /**PATH C:\tungc\App Installation\xampp742\htdocs\laravel8scholarship\resources\views/scholarship/pdf/submit.blade.php ENDPATH**/ ?>