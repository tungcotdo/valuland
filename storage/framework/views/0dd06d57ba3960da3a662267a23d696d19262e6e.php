              ...
              <div class="card-body">
                  <div class="row g-3">
                      <div class="col-md-6 validate">
                        ...
                        <input type="text" class="form-control" id="owner_code" name="owner_code" value="<?php echo e($owner->owner_code); ?>">
                        <small class="error-message text-danger"></small>
                      </div>
                      <div class="col-md-6 validate">
                        <label for="owner_name" class="form-label">Tên</label>
                        <input type="text" class="form-control" id="owner_name" name="owner_name" value="<?php echo e($owner->owner_name); ?>">
                        <small class="error-message text-danger"></small>
                      </div>
                      <div class="col-md-6 validate">
                        <label for="owner_email" class="form-label">Email <small class="text-danger">(Ngăn cách bằng dấu ;)</small></label>
                        <input type="text" class="form-control" id="owner_email" name="owner_email" value="<?php echo e($owner->owner_email); ?>">
                        <small class="error-message text-danger"></small>
                      </div>
                      <div class="col-md-6 validate">
                        <label for="owner_phone" class="form-label">Số điện thoại</label>
                        <input type="text" class="form-control" id="owner_phone" name="owner_phone" value="<?php echo e($owner->owner_phone); ?>">
                        <small class="error-message text-danger"></small>
                      </div>
                      <div class="col-md-6">
